...
function validateNumberInput(input) {
  ...
  function calculateScore() {
    ...
    resultElement.textContent =
      "Средняя оценочная стоимость аренды вашей квартиры составляет: сом  " + score;
    ...
    parametersInfo += "<b>С детьми:</b> " + answers["childrens"] + "<br>";
    parametersInfo += "<b>С животными</b> " + answers["pet"] + "<br>";
    ...
    parametersInfo += "<b>Заключать договор аренды:</b> " + answers["arenda"] + "<br>";
